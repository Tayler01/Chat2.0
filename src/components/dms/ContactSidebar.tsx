...
import { User, DMConversation } from '../../hooks/useDirectMessages';
...
export function ContactSidebar({
  ...
  return (
    <div className="w-full md:w-80 bg-gray-800 rounded-xl border border-gray-600/50 shadow-xl flex-col overflow-hidden flex">
                            ...
                            <p className="text-white font-medium truncate flex items-center gap-1">
                              ...
                              {(() => {
                                const conv = conversations.find((c) =>
                                  ...
                                  (c.user2_id === user.id && c.user1_id !== user.id)
                                );
